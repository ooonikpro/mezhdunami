<template>
  <div class="calendar-skeleton">
    <div
      v-for="item in 3"
      :key="item"
      class="calendar-skeleton-column"
    >
...
<style lang="scss" scoped>
  ...
  .calendar-skeleton-column {
    flex: 0 0 auto;
    width: 20rem;
    padding-top: 5.2rem;
  }

  .calendar-skeleton-slots {
    border-radius: 4px;
    border: 1px solid rgba($color-pink-700, 0.25);
  }

  .calendar-skeleton-slot {
    display: flex;
    height: 5rem;
